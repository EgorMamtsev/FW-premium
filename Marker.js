    ...
    .then(() => {
      ...
      function findStatus() {
        let statusInt = setInterval(() => {
          let statusBox = document.querySelector(
      ...
      function addComent() {
        let postBtnArea = document.querySelector("lgt-form-actions.fit");
        let postBnt = postBtnArea.querySelectorAll("button.lgt-button-text");
        let dispComments = document.querySelector("div.dispatch-comments");
        let textArea = dispComments.querySelector(
          "textarea.cdk-textarea-autosize"
        );
      ...
      function findEditButton() {
        let findEditButtonInt = setInterval(() => {
          ...
          let editBnt = findEditBtnBlock.querySelector(
            "button.lgt-button-white"
          );
          if (editBnt !== null) {
